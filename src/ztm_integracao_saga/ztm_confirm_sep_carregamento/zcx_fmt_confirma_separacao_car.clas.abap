class ZCX_FMT_CONFIRMA_SEPARACAO_CAR definition
  public
...
public section.
  ...
  data STANDARD type ZEXCHANGE_FAULT_DATA2 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZEXCHANGE_FAULT_DATA2 optional
...
CLASS ZCX_FMT_CONFIRMA_SEPARACAO_CAR IMPLEMENTATION.
