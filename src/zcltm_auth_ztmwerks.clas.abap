...
"!<p><strong>Data:</strong> 12/05/2022</p>
CLASS zcltm_auth_ztmwerks DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS gc_object TYPE xuobject VALUE 'ZTMWERKS'.
...
CLASS ZCLTM_AUTH_ZTMWERKS IMPLEMENTATION.
