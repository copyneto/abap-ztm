...
define view entity ZI_TM_COCKPIT_ITEM_EXECUCAO
  ...
  association to parent ZI_TM_COCKPIT_PRESTACAO_CONTAS as _Cockpit on  _Cockpit.FreightOrderUUID = $projection.FreightOrderUUID
