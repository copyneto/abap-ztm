*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVTM_TPVEI_SAGA
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVTM_TPVEI_SAGA     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVTM_TPVEI_SAGA'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVTM_TPVEI_SAGA_EXTRACT
TOTAL = ZVTM_TPVEI_SAGA_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVTM_TPVEI_SAGA'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVTM_TPVEI_SAGA-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVTM_TPVEI_SAGA_EXTRACT
TOTAL = ZVTM_TPVEI_SAGA_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVTM_TPVEI_SAGA-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVTM_TPVEI_SAGA'
...
TOTAL = ZVTM_TPVEI_SAGA_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVTM_TPVEI_SAGA-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVTM_TPVEI_SAGA-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVTM_TPVEI_SAGA'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVTM_TPVEI_SAGA-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVTM_TPVEI_SAGA_EXTRACT
TOTAL = ZVTM_TPVEI_SAGA_TOTAL
