class ZCX_FMT_FRETE_ORDEM definition
  public
...
public section.
  ...
  data STANDARD type ZEXCHANGE_FAULT_DATA3 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZEXCHANGE_FAULT_DATA3 optional
...
CLASS ZCX_FMT_FRETE_ORDEM IMPLEMENTATION.
