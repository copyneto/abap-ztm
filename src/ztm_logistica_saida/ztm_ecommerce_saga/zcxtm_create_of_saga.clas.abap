class ZCXTM_CREATE_OF_SAGA definition
  public
...
public section.
  ...
  constants:
    begin of ZCXTM_CREATE_OF_SAGA,
      msgid type symsgid value 'ZTM_CREATE_OF_SAGA',
      msgno type symsgno value '000',
      attr1 type scx_attrname value '',
      attr2 type scx_attrname value '',
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCXTM_CREATE_OF_SAGA .
  constants:
    begin of UF_NAO_LOCALIZADA,
      msgid type symsgid value 'ZTM_CREATE_OF_SAGA',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of UF_NAO_LOCALIZADA .
  constants:
    begin of TPVEICULO_NAO_LOCALIZADO,
      msgid type symsgid value 'ZTM_CREATE_OF_SAGA',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of TPVEICULO_NAO_LOCALIZADO .
...
CLASS ZCXTM_CREATE_OF_SAGA IMPLEMENTATION.
...
if textid is initial.
  IF_T100_MESSAGE~T100KEY = ZCXTM_CREATE_OF_SAGA .
else.
