@EndUserText.label: 'Roadnet - Items'
@ObjectModel.query.implementedBy: 'ABAP:ZCLTM_PARAM_ROADNET_ENTR_CE'
...
define custom entity ZC_TM_PARAM_ROADNET_NEW_ENTR
{
      // ------------------------------------------------------
      // Header information
      // ------------------------------------------------------
      ...
      @UI.lineItem          : [ { type: #FOR_ACTION, dataAction: 'importar_entr', label: 'Importar Entrega', invocationGrouping: #CHANGE_SET } ]
