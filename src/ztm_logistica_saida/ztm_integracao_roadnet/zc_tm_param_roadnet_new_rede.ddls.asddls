...
@ObjectModel.query.implementedBy: 'ABAP:ZCLTM_PARAM_ROADNET_REDE_CE'
...
define custom entity ZC_TM_PARAM_ROADNET_NEW_REDE
{
      // ------------------------------------------------------
      // Header information
      // ------------------------------------------------------
      ...
      @UI.lineItem          : [ { type: #FOR_ACTION, dataAction: 'importar_rede', label: 'Importar Redespacho', invocationGrouping: #CHANGE_SET } ]
