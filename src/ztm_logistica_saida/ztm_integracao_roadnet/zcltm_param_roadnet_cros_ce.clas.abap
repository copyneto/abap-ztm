CLASS zcltm_param_roadnet_cros_ce DEFINITION
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             centro       TYPE RANGE OF zc_tm_param_roadnet_new_cros-centro,
             session_data TYPE RANGE OF zc_tm_param_roadnet_new_cros-session_data,
             session_id   TYPE RANGE OF zc_tm_param_roadnet_new_cros-session_id,
             route_id     TYPE RANGE OF zc_tm_param_roadnet_new_cros-route_id,
           END OF ty_filter,

           ty_result   TYPE zc_tm_param_roadnet_new_cros,
...
CLASS zcltm_param_roadnet_cros_ce IMPLEMENTATION.
  ...
  METHOD if_rap_query_provider~select.
    ...
    DATA: lt_result_s TYPE SORTED TABLE OF zc_tm_param_roadnet_new_cros
