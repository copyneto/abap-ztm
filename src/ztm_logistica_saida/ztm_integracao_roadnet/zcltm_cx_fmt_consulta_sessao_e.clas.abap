class ZCLTM_CX_FMT_CONSULTA_SESSAO_E definition
  public
...
public section.
  ...
  data STANDARD type ZCLTM_EXCHANGE_FAULT_DATA read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLTM_EXCHANGE_FAULT_DATA optional
...
CLASS ZCLTM_CX_FMT_CONSULTA_SESSAO_E IMPLEMENTATION.
