CLASS zcltm_param_roadnet_entr_ce DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             centro       TYPE RANGE OF zc_tm_param_roadnet_new_entr-centro,
             session_data TYPE RANGE OF zc_tm_param_roadnet_new_entr-session_data,
             session_id   TYPE RANGE OF zc_tm_param_roadnet_new_entr-session_id,
             route_id     TYPE RANGE OF zc_tm_param_roadnet_new_entr-route_id,
           END OF ty_filter,

           ty_result   TYPE zc_tm_param_roadnet_new_entr,
...
CLASS zcltm_param_roadnet_entr_ce IMPLEMENTATION.
  ...
  METHOD if_rap_query_provider~select.
    ...
    DATA: lt_result_s TYPE SORTED TABLE OF zc_tm_param_roadnet_new_entr
