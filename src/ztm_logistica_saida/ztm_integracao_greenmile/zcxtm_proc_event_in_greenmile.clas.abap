class ZCXTM_PROC_EVENT_IN_GREENMILE definition
  public
...
public section.
  ...
  constants:
    begin of ZCXTM_PROC_EVENT_IN_GREENMILE,
      msgid type symsgid value 'ZTM_EVENT_IN_GREENMI',
    ...
    end of ZCXTM_PROC_EVENT_IN_GREENMILE .
  constants:
    begin of ERRO_EVENTO_TM,
      msgid type symsgid value 'ZTM_EVENT_IN_GREENMI',
...
CLASS ZCXTM_PROC_EVENT_IN_GREENMILE IMPLEMENTATION.
...
if textid is initial.
  IF_T100_MESSAGE~T100KEY = ZCXTM_PROC_EVENT_IN_GREENMILE .
else.
