...
CLASS ZCLTM_UPLOAD_FILE_GKO IMPLEMENTATION.
  ...
  METHOD process.
    ...
    TRY.
        lv_path = iv_path.
* BEGIN OF DELETE - 15.06.2023 - 8000008265 - ERRO ENDEREÇO PARA PATH - ZCLTM_UPLOAD_F
*        lv_path = '/interfaces/S4D/GKO/'.
* END OF DELETE - 15.06.2023 - 8000008265 - ERRO ENDEREÇO PARA PATH - ZCLTM_UPLOAD_F
