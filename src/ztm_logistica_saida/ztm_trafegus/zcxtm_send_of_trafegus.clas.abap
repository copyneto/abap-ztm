class ZCXTM_SEND_OF_TRAFEGUS definition
  public
...
public section.
  ...
  constants:
    begin of ZCXTM_SEND_OF_TRAFEGUS,
      msgid type symsgid value 'ZTM_OF_TRAFEGUS',
    ...
    end of ZCXTM_SEND_OF_TRAFEGUS .
  constants:
    begin of EXISTE_NF_NAO_AUTORIZADA,
      msgid type symsgid value 'ZTM_OF_TRAFEGUS',
    ...
    end of EXISTE_NF_NAO_AUTORIZADA .
...
CLASS ZCXTM_SEND_OF_TRAFEGUS IMPLEMENTATION.
...
if textid is initial.
  IF_T100_MESSAGE~T100KEY = ZCXTM_SEND_OF_TRAFEGUS .
else.
