CLASS zcl_tcc_calc_cond DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PRIVATE SECTION.
    ...
    METHODS add_perc_calculation_rate
      ...
      RAISING
        /scmtms/cx_tccs_engine
        /scmtms/cx_tc_calc_engine .
...
CLASS ZCL_TCC_CALC_COND IMPLEMENTATION.
  ...
  METHOD /scmtms/if_tc_calc_methods~calculate_multi.
