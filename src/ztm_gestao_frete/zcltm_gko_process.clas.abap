...
*      END OF ty_s_item_arredondamento .
  ...
  class-methods DETERMINA_CONFIGURACAO_P013
    ...
    exporting
      ...
      !EV_EXPED_BRANCH type T001W-J_1BBRANCH
      !EV_RECEB_BRANCH type T001W-J_1BBRANCH
...
* BEGIN OF INSERT - RPORTES - 25.05.2023 - 8000007483, CORE4 - ERRO DETERMIN CENTRO DE CUSTO
    SELECT werks, kunnr, j_1bbranch
      INTO TABLE @DATA(lt_exped_branch)
      FROM t001w
      WHERE kunnr = @es_header-exped_cod.

    SELECT werks, kunnr, j_1bbranch
      INTO TABLE @DATA(lt_receb_branch)
      FROM t001w
      WHERE kunnr = @es_header-receb_cod.
...
* BEGIN OF INSERT - RPORTES - 25.05.2023 - 8000007483, CORE4 - ERRO DETERMIN CENTRO DE CUSTO
    IF lt_exped_branch IS NOT INITIAL.
      ev_exped_branch = lt_exped_branch[ 1 ]-j_1bbranch. "werks.
    ENDIF.

    IF lt_receb_branch IS NOT INITIAL.
      ev_receb_branch = lt_receb_branch[ 1 ]-j_1bbranch. "werks.
    ENDIF.
* END OF INSERT - RPORTES - 25.05.2023 - 8000007483, CORE4 - ERRO DETERMIN CENTRO DE CUSTO
...
* BEGIN OF INSERT - RPORTES - 19.05.2023 - 8000007483, CORE4 - ERRO DETERMIN CENTRO DE CUSTO
        ...
        AND loc_ret     = @ev_exped_branch
        AND loc_ent     = @ev_receb_branch.
