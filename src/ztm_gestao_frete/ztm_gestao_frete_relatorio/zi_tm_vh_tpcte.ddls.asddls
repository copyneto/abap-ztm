...
@EndUserText.label: 'Search  Help: Tipo CTE'
...
define view entity ZI_TM_VH_TPCTE
...
{
      @ObjectModel.text.element: ['desc_tpcte']
  key cast( Domain.domvalue_l as ze_gko_tpcte  ) as tpcte,
      @Semantics.text: true
      @Search.defaultSearchElement: true
      @Search.ranking: #HIGH
      @Search.fuzzinessThreshold: 0.7
      _Text.ddtext                               as desc_tpcte,
      @Search.defaultSearchElement: true
      @Search.ranking: #MEDIUM
      @Search.fuzzinessThreshold: 0.7
      @UI.hidden: true
      Domain.domvalue_l                          as tpcte_search
