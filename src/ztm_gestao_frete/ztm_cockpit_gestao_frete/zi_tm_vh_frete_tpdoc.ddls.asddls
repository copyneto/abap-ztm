...
define view entity ZI_TM_VH_FRETE_TPDOC
                                   ...
                                   and _Text.ddlanguage = $session.system_language
{
  ...
  key cast( Domain.domvalue_l as ze_gko_tpdoc   ) as tpdoc,
      @Semantics.text: true
      @Search.defaultSearchElement: true
      @Search.ranking: #HIGH
      @Search.fuzzinessThreshold: 0.7
      _Text.ddtext                                as tpdoc_txt,
      @Search.ranking: #MEDIUM
      @Search.defaultSearchElement: true
      @Search.fuzzinessThreshold: 0.8
      @UI.hidden: true
      Domain.domvalue_l                           as tpdoc_search

}
where
      Domain.domname  = 'ZD_GKO_TPDOC'
