...
define view entity ZI_TM_COCKPIT001_DOCDFF_E

  as select from    /scmtms/d_torrot as torrot

    left outer join wbrp             as wbrp       on wbrp.ref_doc_nr_2 = torrot.tor_id

    left outer join /scmtms/d_sf_rot as sf_rot     on sf_rot.sfir_id = wbrp.ref_doc_nr_1
  //and sf_rot.lifecycle = '04'
  //and sf_rot.lifecycle <> '06' -- Cancelado
  //and sf_rot.lifecycle is not null
...
{
  key torrot.tor_id                                     as tor_id,
  key bintohex( sf_rot.db_key )                         as db_key,
  key wbrp.ref_doc_nr_1                                 as ref_doc_nr_1,
      ...
      sf_rot.zzacckey                                   as acckey
}
where
      torrot.tor_cat   =  'TO'
  and torrot.tor_id    is not initial
  and sf_rot.lifecycle <> '06'
