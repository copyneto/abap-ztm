CLASS zcltm_cockpit_frete_log_new_ce DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcltm_cockpit_frete_log_new_ce IMPLEMENTATION.

  METHOD if_rap_query_provider~select.

    TYPES: ty_t_result TYPE SORTED TABLE OF zc_tm_cockpit_log_new
...
** Monta relatório
** ---------------------------------------------------------------------------
    DATA(lt_result) = lo_cockpit->build_log( iv_filter = lv_filter ).
...
* ---------------------------------------------------------------------------
    ...
    SORT lt_result BY acckey DESCENDING counter DESCENDING.
