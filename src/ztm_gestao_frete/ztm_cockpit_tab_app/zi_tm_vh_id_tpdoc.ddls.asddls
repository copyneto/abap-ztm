@AbapCatalog.sqlViewName: 'ZVTM_TPDOC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Search Help Doc Type'
...
define view ZI_TM_VH_ID_TPDOC as select from dd07l as Domain
...
where
      Domain.domname  = 'ZD_GKO_TPDOC' //'ZD_GKO_TIPO_DOC'
