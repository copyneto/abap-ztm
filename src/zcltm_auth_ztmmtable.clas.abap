...
"!<p><strong>Data:</strong> 09/05/2022</p>
CLASS zcltm_auth_ztmmtable DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS gc_object TYPE xuobject VALUE 'ZTMMTABLE'.
...
CLASS ZCLTM_AUTH_ZTMMTABLE IMPLEMENTATION.
