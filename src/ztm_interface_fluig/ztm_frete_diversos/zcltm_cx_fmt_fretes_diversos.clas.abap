class ZCLTM_CX_FMT_FRETES_DIVERSOS definition
  public
...
public section.
  ...
  data STANDARD type ZCLTM_EXCHANGE_FAULT_DATA1 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLTM_EXCHANGE_FAULT_DATA1 optional
...
CLASS ZCLTM_CX_FMT_FRETES_DIVERSOS IMPLEMENTATION.
